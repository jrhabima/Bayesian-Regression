...
matplot(beta_out, type = "l")

plot(sigma_out, type = "l")
layout(matrix(1:6, 2,3))
apply(beta_out, 2, function(x){hist(x, xlim = c(-3,3))})
apply(beta_out, 2, function(x){plot(density(x), col = "red")})
...
beta_hat <- apply(beta_out, 2, mean)
